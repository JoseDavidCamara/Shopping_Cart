...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-11-2023 a las 19:20:59
...
('root', '[{\"db\":\"videojuegos\",\"table\":\"videojuegos\"}]');
...
('root', '2023-11-15 18:10:31', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"es\"}');
...
--
CREATE DATABASE IF NOT EXISTS `videojuegos` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `videojuegos`;
...
INSERT INTO `videojuegos` (`id`, `titulo`, `genero`, `precio`) VALUES
(1, 'hola', 'Action', 123),
(2, '089', 'Action', 908);
